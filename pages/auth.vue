  ...
  <div id="AuthPage" class="w-full h-[100vh] bg-white">
    ...
    >
      <NuxtLink to="/" class="min-w-[170px]">
        <NuxtImg width="170" src="img/AliExpress-logo.png" />
      </NuxtLink>
    </div>
    <div class="max-w-[400px] mx-auto px-2">
      ...
      >
        <NuxtImg class="w-full max-w-[30px]" src="img/google-logo.png" />
        <div>Google</div>
      </button>
      ...
      >
        <NuxtImg class="w-full max-w-[30px]" src="img/github-logo.png" />
        <div>Github</div>
      </button>
    </div>
  </div>
